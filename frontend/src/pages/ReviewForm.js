...
function ReviewForm() {
    ...
    function handleEvalCheckbox(evalTypeId) {
        if (selectedEvalTypeIDs.indexOf(evalTypeId) !== -1) {
            setSelectedEvalTypeIDs(
                selectedEvalTypeIDs.filter(function (i) {
                    return i !== evalTypeId;
                }),
            );
        } else {
    ...
    function handleSubmit() {
        ...
        var keywordStrings = keywordInput
            .split(",")
            .map(function (k) {
                return k.trim();
            })
        ...
        fetch("http://localhost:8080/reviews", {
            ...
            body: JSON.stringify({
                ...
                GradeAchieved: isCompleted === "yes" && gradeAchieved !== "" ? parseFloat(gradeAchieved) : null,
    ...
    return (
        <div className="review-form-page">
            ...
            <h1>
                Review for {course.CourseCode} - {course.CourseName}
            </h1>
                                ...
                                return (
                                    <label key={et.EvalTypeID}>
                                        <input
                                            ...
                                            onChange={function () {
                                                handleEvalCheckbox(et.EvalTypeID);
                                            }}
                                        />
                                        {et.EvalTitle}
                                    </label>
